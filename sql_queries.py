...
time_table_create = """CREATE TABLE IF NOT EXISTS time (start_time timestamp PRIMARY KEY UNIQUE NOT NULL, 
                                                      hour int NOT NULL, 
                                                      day int NOT NULL, 
                                                      week int NOT NULL, 
                                                      month int NOT NULL, 
...
user_table_insert = """INSERT INTO users (user_id, 
                     ...
                     SET level = EXCLUDED.level || ';' || users.level;"""
...
song_select = """SELECT a.artist_id,
                        s.song_id
                   FROM songs s 
                   JOIN artists a 
